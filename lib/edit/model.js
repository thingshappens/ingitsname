...
const VERSION = 'edit-v1-candidate-1';
...
function validate(input, available=voices()) {
  ...
  return {product:'the_edit',phrase:input.phrase.trim(),voiceId:voice.id,voiceRange:voice.range,bpm:input.bpm,cutCount:cuts.length,cuts};
}
...
module.exports={VERSION,STYLES,GROOVES,AMOUNTS,PRICES,InputError,cutKey,voices,validate,hash,tokenMatches,filename};
