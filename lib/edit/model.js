...
const VERSION = 'edit-v2-felix-pilot-01';
const STYLES = {clean:'Clean As Fuck',dark_echo:'Dark & Echo',sexy_robot:'Sexy Robot'};
// The Edit only presents HSC characters. Their source recordings are owned or
// commissioned by HSC; this catalogue must never fall back to an AI voice API.
const CHARACTERS = [{
  id:'felix-lousive',
  name:'Monsieur Felix Lousive',
  shortName:'Felix',
  range:'mid',
...
module.exports={VERSION,STYLES,DELIVERIES,PRICES,CHARACTERS,InputError,cutKey,voices,validate,hash,tokenMatches,filename};
