...
function filters(c,order,samples){
  let style=[];
  if(c.style==='clean')style=['aecho=0.9:1:35|62|96|132:0.22|0.16|0.10|0.06'];
  ...
  const duration=samples.length/SR+(c.style==='clean'?.15:c.style==='dark_echo'?60/order.bpm*2.25:c.style==='sexy_robot'?60/order.bpm*1.25:c.style==='chopped_up'?60/order.bpm*.5:0);
