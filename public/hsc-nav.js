...
(function () {
  ...
  var CSS = ".hsc-shell{min-height:92px;padding:0 clamp(22px,4.8vw,78px);display:grid;grid-template-columns:minmax(260px,1fr) auto minmax(260px,1fr);align-items:center;gap:30px;border-bottom:1px solid var(--line,#2a2620)}" +
    ...
    "@media(max-width:1180px){.hsc-shell{grid-template-columns:1fr;justify-items:center;gap:13px;padding:17px 24px 15px}.hsc-shell .brand{justify-content:center}.hsc-nav{justify-content:center;flex-wrap:wrap;row-gap:9px}.hsc-context{display:none}}" +
